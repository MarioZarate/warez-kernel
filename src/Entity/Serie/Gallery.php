...
/**
 * App\Entity\Serie\Gallery
 *
 * @ORM\Entity(repositoryClass="App\Repository\Serie\GalleryRepository")
 * @ORM\Table(name="gallery", indexes={@ORM\Index(name="fk_gallery_serie1_idx", columns={"serie_id"})}, uniqueConstraints={@ORM\UniqueConstraint(name="id_UNIQUE", columns={"id"}), @ORM\UniqueConstraint(name="photo_UNIQUE", columns={"photo"})})
 */
class Gallery
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Serie", inversedBy="galleries")
     ...
     *
     * @param string $id
     * @return \App\Entity\Serie\Gallery
     */
    ...
    {
        return array('id', 'serie_id', 'photo', 'reorder', 'created_date', 'updated_date');
    }
}
